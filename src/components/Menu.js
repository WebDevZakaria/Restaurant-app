...
const Menu = () => {
  ...
  return <section className='min-h-[780px] '>
    ...
    y:150,
    }} whileInView={{opacity:1,y:0}} transition={{type:'tween',delay:0.2,duration:1.6,ease:'easeOut' }} className='relative top-80 lg:top-96'>
...
{menuItems.map((item,index)=>{
  ...
  return <div key={index}>
    <div className='flex flex-row lg:flex-col h-full'>
      ...
      <div className='bg-[#d34f6b] flex1 flex flex-col justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max'>

...
function Homes() {
  ...
  <div className='container mx-auto min-h-[680px] flex justify-center items-center mt-1 mb-0'>

<motion.div variants={staggerContainer(0.3, 1)} initial = 'hidden' whileInView={'show'}  className='text-center flex flex-col items-center rounded-lg py-0'>

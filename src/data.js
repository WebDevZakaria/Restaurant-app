import {
  ...
  import MenuImg1 from '../src/assets/img/menu/4.png';
  ...
  export const heroData = {
    pretitle: 'Nothing is like',
    title: 'Bridge restaurant',
    subtitle:
      'command and reserve your table with us ',
  ...
  export const aboutData = {
    ...
    title: 'who we are',
    subtitle:
      'restaurant with delicious food of every category ,here you can eat every think you think about and find the best services and the hospitalite ',
  ...
  export const teamData = {
    pretitle: 'our team',
    title: 'meet our chef',
    sub1: ' connect with our chef ',
    sub2: '',
    name: 'Zakaria Bouregbi',
  ...
  export const testimonialData = {
    ...
    slider: [
      {
        message:
          'good qualite and nice hospitalite thanks to all of you guys ',
      ...
      {
        message:
          'thank you for this delicius food nice to meet the chef and all of you ',
